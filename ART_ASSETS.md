...
**209 files wanted · 12 already present · 197 to provide.**
...
| x | `bg_warrens.png` | 1280x720 | The Warrens (difficulty 2, The Hollow Barrows). Overrun. Nothing here fights alone, and the tunnels double back.  Its boss is The Brood-Mother. |
| x | `bg_foundry.png` | 1280x720 | The Foundry (difficulty 3, The Ashen Foundry). Hammers in the dark. The things here hit back harder.  Its boss is The Forge-Warden. |
| x | `bg_ember_road.png` | 1280x720 | The Ember Road (difficulty 3, The Ashen Foundry). A causeway of slag. It is still cooling.  Its boss is The Bellows-Master. |
| x | `bg_slag_pits.png` | 1280x720 | The Slag Pits (difficulty 4, The Ashen Foundry). Molten channels and the shapes that wade them.  Its boss is The Cinder Knight. |
| x | `bg_fungal_deep.png` | 1280x720 | The Fungal Deep (difficulty 4, The Verdant Rot). The air is thick and it is breathing with you.  Its boss is The Mycelial Lord. |
| x | `bg_rot_gardens.png` | 1280x720 | The Rot Gardens (difficulty 5, The Verdant Rot). Something cultivated this. Something still tends it.  Its boss is The Gardener. |
| x | `bg_sunken_vault.png` | 1280x720 | The Sunken Vault (difficulty 5, The Sunken Deeps). Sealed for a reason. The deepest known door.  Its boss is The Deep Warden. |
| x | `bg_drowned_market.png` | 1280x720 | The Drowned Market (difficulty 6, The Sunken Deeps). Stalls, still stocked. Vendors, still present.  Its boss is The Last Vendor. |
| x | `bg_abyssal_stair.png` | 1280x720 | The Abyssal Stair (difficulty 7, The Sunken Deeps). Down, and then further down. The steps are not all stone.  Its boss is The False Step. |
| x | `bg_the_maw.png` | 1280x720 | The Maw (difficulty 8, Beyond the Stair). It does not have a bottom. It has an appetite.  Its boss is The Maw Itself. |
