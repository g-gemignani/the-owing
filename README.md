...
[![tests](https://img.shields.io/badge/tests-41%20suites-brightgreen)](#tests)
...
> frame kit that is *computed* rather than drawn. 41 test suites, including one that
...
| Tests          | 41 suites, including a playability integration test            |
...
above is either read live from GitHub or asserted by a test: the `41 suites` count is
