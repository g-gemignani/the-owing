...
Chapters 1–8 are the architecture and the plan; everything after them is the decision
log, which is most of the file. The log is **not in numeric order** — entries land as
they are written and a correction lands beside its subject — so the index below is the
way in.

<!-- BEGIN GENERATED INDEX -- tools/design_index.sh -->

### The decision log, by number

Generated by `tools/design_index.sh` — do not edit between the markers.
Entries are not in numeric order in the file below; this is the way in.

| # | decision |
|---|---|
| **D35** | [Fusion was free power](#d35--fusion-was-free-power) |
| **D36** | [Enemies stopped matching you forever](#d36--enemies-stopped-matching-you-forever) |
| **D37** | [Player Powers](#d37--player-powers) |
| **D38** | [Enemies that react, and bosses with signatures](#d38--enemies-that-react-and-bosses-with-signatures) |
| **D39** | [A painted title screen](#d39--a-painted-title-screen) |
| **D40** | [Relics that change how you play](#d40--relics-that-change-how-you-play) |
| **D41** | [Twelve dungeons, twelve bosses](#d41--twelve-dungeons-twelve-bosses) |
| **D42** | [Making the game expandable](#d42--making-the-game-expandable) |
| **D43** | [Exporting, and the bug only an export could find](#d43--exporting-and-the-bug-only-an-export-could-find) |
| **D44** | [Staying exportable to platforms we cannot build](#d44--staying-exportable-to-platforms-we-cannot-build) |
| **D45** | [The curve flatlined, and Block was why](#d45--the-curve-flatlined-and-block-was-why) |
| **D46** | [Reward tension and in-run deck shaping](#d46--reward-tension-and-in-run-deck-shaping) |
| **D47** | [A black screen shipped, and the suite stayed green for five commits](#d47--a-black-screen-shipped-and-the-suite-stayed-green-for-five-commits) |
| **D49** | [Default UI scale 1.0](#d49--default-ui-scale-10) |
| **D50** | [A card must not lie about itself](#d50--a-card-must-not-lie-about-itself) |
| **D51** | [Filter and sort the collection](#d51--filter-and-sort-the-collection) |
| **D52** | [A way out of the fight, and Escape means it](#d52--a-way-out-of-the-fight-and-escape-means-it) |
| **D53** | [The Music bus finally has music on it](#d53--the-music-bus-finally-has-music-on-it) |
| **D54** | [The endgame stopped being a walkover](#d54--the-endgame-stopped-being-a-walkover) |
| **D55** | [AGENTS.md, and a hook that keeps the docs honest](#d55--agentsmd-and-a-hook-that-keeps-the-docs-honest) |
| **D56** | [Art direction, and looking at the game before talking about it](#d56--art-direction-and-looking-at-the-game-before-talking-about-it) |
| **D57** | [Two bugs the renders found, and the assertion that was missing](#d57--two-bugs-the-renders-found-and-the-assertion-that-was-missing) |
| **D58** | [A card must not lie about the fight either](#d58--a-card-must-not-lie-about-the-fight-either) |
| **D59** | [Three places the game asked for a decision without showing the numbers](#d59--three-places-the-game-asked-for-a-decision-without-showing-the-numbers) |
| **D60** | [The dodge nobody had ever measured](#d60--the-dodge-nobody-had-ever-measured) |
| **D61** | [Making the fight move](#d61--making-the-fight-move) |
| **D62** | [The fight is framed head-on, and nobody plays the hero](#d62--the-fight-is-framed-head-on-and-nobody-plays-the-hero) |
| **D63** | [The bottom of the screen, laid out properly](#d63--the-bottom-of-the-screen-laid-out-properly) |
| **D64** | [The horizon is not the standing line](#d64--the-horizon-is-not-the-standing-line) |
| **D65** | [The UI scale was a second scale](#d65--the-ui-scale-was-a-second-scale) |
| **D66** | [Cards that read the fight](#d66--cards-that-read-the-fight) |
| **D67** | [Twelve dungeons, twelve shapes](#d67--twelve-dungeons-twelve-shapes) |
| **D68** | [The elite drops a relic, and escrow holds it](#d68--the-elite-drops-a-relic-and-escrow-holds-it) |
| **D69** | [The plateau was an incentive, not a difficulty](#d69--the-plateau-was-an-incentive-not-a-difficulty) |
| **D70** | [Two art paths with no code behind them](#d70--two-art-paths-with-no-code-behind-them) |
| **D71** | [The merchant sold nothing, because prices were flat and income is not](#d71--the-merchant-sold-nothing-because-prices-were-flat-and-income-is-not) |
| **D72** | [The simulator was measuring a weaker player than the game gives you](#d72--the-simulator-was-measuring-a-weaker-player-than-the-game-gives-you) |
| **D73** | [Twelve painted rooms, and the filename is the wiring](#d73--twelve-painted-rooms-and-the-filename-is-the-wiring) |
| **D74** | [A fourth way to walk a dungeon: an isometric floor, because the best of the other three was the problem](#d74--a-fourth-way-to-walk-a-dungeon-an-isometric-floor-because-the-best-of-the-other-three-was-the-problem) |
| **D75** | [A tuning pass, now that the instrument reads true](#d75--a-tuning-pass-now-that-the-instrument-reads-true) |
| **D76** | [The simulator was spending its life in ResourceLoader](#d76--the-simulator-was-spending-its-life-in-resourceloader) |
| **D77** | [The floor became a place: real ground, things walking it, and no torch](#d77--the-floor-became-a-place-real-ground-things-walking-it-and-no-torch) |
| **D78** | [The floor got its art, and most of the work was not drawing](#d78--the-floor-got-its-art-and-most-of-the-work-was-not-drawing) |
| **D79** | [The floor became a building: rooms, floors, sealed vaults, and a pacing ceiling](#d79--the-floor-became-a-building-rooms-floors-sealed-vaults-and-a-pacing-ceiling) |
| **D80** | [Sealed packs: a reward that has to survive the walk home](#d80--sealed-packs-a-reward-that-has-to-survive-the-walk-home) |
| **D81** | [Packs got a type and a tier, and the fusion curve did not move](#d81--packs-got-a-type-and-a-tier-and-the-fusion-curve-did-not-move) |
| **D82** | [Terrain as a second axis, and the samey test that made the styles earn their keep](#d82--terrain-as-a-second-axis-and-the-samey-test-that-made-the-styles-earn-their-keep) |
| **D83** | [The buttons were a smear, and the reason was mechanical](#d83--the-buttons-were-a-smear-and-the-reason-was-mechanical) |
| **D83b** | [Three scene backdrops, and a letterbox that was not there](#d83b--three-scene-backdrops-and-a-letterbox-that-was-not-there) |
| **D83c** | [The generator signs its work, and finding the signature was the hard part](#d83c--the-generator-signs-its-work-and-finding-the-signature-was-the-hard-part) |
| **D83d** | [Six more backdrops, and a filename that would have overwritten a fight](#d83d--six-more-backdrops-and-a-filename-that-would-have-overwritten-a-fight) |
| **D83e** | [Card frames, computed; and the illustration hook that was treating paintings as icons](#d83e--card-frames-computed-and-the-illustration-hook-that-was-treating-paintings-as-icons) |
| **D84** | [Chests, keys, vaults, and the generator that was inventing fights](#d84--chests-keys-vaults-and-the-generator-that-was-inventing-fights) |
| **D85** | [The floor was lying about what you were walking towards](#d85--the-floor-was-lying-about-what-you-were-walking-towards) |
| **D86** | [Two keys, two locks, one idea: resolved by deleting mine](#d86--two-keys-two-locks-one-idea-resolved-by-deleting-mine) |
| **D87** | [WASD on a rotated grid, and the tiles that stopped looking like tiles](#d87--wasd-on-a-rotated-grid-and-the-tiles-that-stopped-looking-like-tiles) |
| **D88** | [Every dungeon became the crawl, and the other three models had been hiding a discount](#d88--every-dungeon-became-the-crawl-and-the-other-three-models-had-been-hiding-a-discount) |
| **D89** | [The art that could not be committed, and the half of it worth generating](#d89--the-art-that-could-not-be-committed-and-the-half-of-it-worth-generating) |
| **D90** | [The art pipeline had a backdrop-shaped hole in it, and the brief was lying about which way the enemies face](#d90--the-art-pipeline-had-a-backdrop-shaped-hole-in-it-and-the-brief-was-lying-about-which-way-the-enemies-face) |
| **D91** | [Twenty-one icons that had to be one image, and an alpha channel taken from the wrong place first](#d91--twenty-one-icons-that-had-to-be-one-image-and-an-alpha-channel-taken-from-the-wrong-place-first) |
| **D92** | [The matte could not reach the background the monster was standing around](#d92--the-matte-could-not-reach-the-background-the-monster-was-standing-around) |
| **D94** | [Three ways to walk a dungeon that nobody could walk, and one label that said the same thing twelve times](#d94--three-ways-to-walk-a-dungeon-that-nobody-could-walk-and-one-label-that-said-the-same-thing-twelve-times) |
| **D95** | [A review of the game as a game, and the five defects worth fixing the same afternoon](#d95--a-review-of-the-game-as-a-game-and-the-five-defects-worth-fixing-the-same-afternoon) |
| **D96** | [The hub was the only screen with no art on it, and the one line meant to sell a zone described no deck](#d96--the-hub-was-the-only-screen-with-no-art-on-it-and-the-one-line-meant-to-sell-a-zone-described-no-deck) |
| **D97** | [The one thing a resting card shows was the one thing the fan covered](#d97--the-one-thing-a-resting-card-shows-was-the-one-thing-the-fan-covered) |
| **D98** | [Thirty-six card names that belonged to another game](#d98--thirty-six-card-names-that-belonged-to-another-game) |
| **D99** | [A ladder built for four rungs on a staircase with two](#d99--a-ladder-built-for-four-rungs-on-a-staircase-with-two) |
| **D101** | [The prompt sheet was describing the wiring, not the picture](#d101--the-prompt-sheet-was-describing-the-wiring-not-the-picture) |
| **D102** | [The prompt sheet was still pasting the operator's half of the page](#d102--the-prompt-sheet-was-still-pasting-the-operators-half-of-the-page) |
| **D103** | [The fourteen constants, and three of them measured worse before one measured right](#d103--the-fourteen-constants-and-three-of-them-measured-worse-before-one-measured-right) |
| **D103b** | [CORRECTION: its absolute table is superseded](#d103b--correction-its-absolute-table-is-superseded) |
| **D104** | [The card was one part pretending to be two](#d104--the-card-was-one-part-pretending-to-be-two) |
| **D105** | [Three of the five were painted into a wall, and the prompt is why](#d105--three-of-the-five-were-painted-into-a-wall-and-the-prompt-is-why) |
| **D106** | [The ids were still the other game's words, and the saves paid for fixing it](#d106--the-ids-were-still-the-other-games-words-and-the-saves-paid-for-fixing-it) |
| **D107** | [A theme icon is not authored at 2x, and a checked box has a fourth state](#d107--a-theme-icon-is-not-authored-at-2x-and-a-checked-box-has-a-fourth-state) |
| **D108** | [The card brief described a card that had already changed twice](#d108--the-card-brief-described-a-card-that-had-already-changed-twice) |
| **D109** | [Seventy-seven per cent of every level-up bought nothing, and the fix moved the whole difficulty axis](#d109--seventy-seven-per-cent-of-every-level-up-bought-nothing-and-the-fix-moved-the-whole-difficulty-axis) |
| **D109b** | [The monsters were not floating; they were standing on a gold lozenge](#d109b--the-monsters-were-not-floating-they-were-standing-on-a-gold-lozenge) |
| **D111** | [The tool was still selling three screens that had been deleted eleven decisions ago](#d111--the-tool-was-still-selling-three-screens-that-had-been-deleted-eleven-decisions-ago) |
| **D112** | [The sheet prompt never said 5x5, and 21 correct drawings landed on 21 wrong meanings](#d112--the-sheet-prompt-never-said-5x5-and-21-correct-drawings-landed-on-21-wrong-meanings) |
| **D113** | [Two controls in one list, drawn from two different rules](#d113--two-controls-in-one-list-drawn-from-two-different-rules) |
| **D114** | [The most-seen painting in the game was off-style, and the doc said it was the style](#d114--the-most-seen-painting-in-the-game-was-off-style-and-the-doc-said-it-was-the-style) |
| **D115** | [The art was on disk and nothing read it, and the screens were being judged 80 rows too tall](#d115--the-art-was-on-disk-and-nothing-read-it-and-the-screens-were-being-judged-80-rows-too-tall) |
| **D116** | [Six cheap fixes, and four of them found something the brief had wrong](#d116--six-cheap-fixes-and-four-of-them-found-something-the-brief-had-wrong) |
| **D117** | [A Label reports its text as a minimum width, and it was eating the hand](#d117--a-label-reports-its-text-as-a-minimum-width-and-it-was-eating-the-hand) |
| **D118** | [The card tier could never have installed, and the generator was blamed for it](#d118--the-card-tier-could-never-have-installed-and-the-generator-was-blamed-for-it) |
| **D119** | [Generating the art through a browser, and the four things that were wrong with asking](#d119--generating-the-art-through-a-browser-and-the-four-things-that-were-wrong-with-asking) |
| **D120** | [The hand is capped at ten, and the simulator cannot see the build it affects](#d120--the-hand-is-capped-at-ten-and-the-simulator-cannot-see-the-build-it-affects) |
| **D121** | [The card illustrations were installed, correct, resolved, and zero pixels wide](#d121--the-card-illustrations-were-installed-correct-resolved-and-zero-pixels-wide) |
| **D122** | [The art that shipped as a placeholder and read as finished](#d122--the-art-that-shipped-as-a-placeholder-and-read-as-finished) |
| **D123** | [Twelve screens with no painting, and four places between them](#d123--twelve-screens-with-no-painting-and-four-places-between-them) |
| **D124** | [Two formulas were charging for draw and disagreeing by four times](#d124--two-formulas-were-charging-for-draw-and-disagreeing-by-four-times) |
| **D125** | [Quiet is not empty, and four backdrops were filled in rather than painted](#d125--quiet-is-not-empty-and-four-backdrops-were-filled-in-rather-than-painted) |
| **D125b** | [Three shipped files were nine-tenths transparent and looked perfect in a file browser](#d125b--three-shipped-files-were-nine-tenths-transparent-and-looked-perfect-in-a-file-browser) |
| **D126** | [The title art's subject was never the problem; the foreground was](#d126--the-title-arts-subject-was-never-the-problem-the-foreground-was) |
| **D127** | [The game was named after its mechanic, in a project whose own rule forbids that](#d127--the-game-was-named-after-its-mechanic-in-a-project-whose-own-rule-forbids-that) |
| **D128** | [The title screen was printing the size of its own data tables](#d128--the-title-screen-was-printing-the-size-of-its-own-data-tables) |
| **D129** | [The last eight files were the two the pipeline was built to refuse](#d129--the-last-eight-files-were-the-two-the-pipeline-was-built-to-refuse) |
| **D130** | [Two settings for the new effects, and one that had never done anything](#d130--two-settings-for-the-new-effects-and-one-that-had-never-done-anything) |
| **D131** | [The hero had two facings for four directions, and one art per card is now on the list](#d131--the-hero-had-two-facings-for-four-directions-and-one-art-per-card-is-now-on-the-list) |
| **D132** | [Three overlays for a hundred cards, and thirds of a track rather than levels](#d132--three-overlays-for-a-hundred-cards-and-thirds-of-a-track-rather-than-levels) |
| **D133** | [Six reported annoyances, and four of them were something else underneath](#d133--six-reported-annoyances-and-four-of-them-were-something-else-underneath) |
| **D134** | [The title screen was 41.5% green against a style bible that is 0.0%](#d134--the-title-screen-was-415-green-against-a-style-bible-that-is-00) |
| **D135** | [Tier 3b asked a hundred times for a rule and expected a picture](#d135--tier-3b-asked-a-hundred-times-for-a-rule-and-expected-a-picture) |
| **D136** | [Four cards to a picture, and the colour fixed after the fact rather than asked for](#d136--four-cards-to-a-picture-and-the-colour-fixed-after-the-fact-rather-than-asked-for) |
| **D137** | [The reference image cannot be attached from here, and saying only what a picture is NOT drains it](#d137--the-reference-image-cannot-be-attached-from-here-and-saying-only-what-a-picture-is-not-drains-it) |
| **D138** | [The pointer is the player's, and the game had taken it](#d138--the-pointer-is-the-players-and-the-game-had-taken-it) |
| **D138b** | [The level overlay does not always work, and the reason is saturation not visibility](#d138b--the-level-overlay-does-not-always-work-and-the-reason-is-saturation-not-visibility) |
| **D139** | [Screen the glow instead of adding it, and the halo goes away](#d139--screen-the-glow-instead-of-adding-it-and-the-halo-goes-away) |
| **D140** | [A resumed dungeon had no floor, and JSON had quietly turned two grids into a sentence](#d140--a-resumed-dungeon-had-no-floor-and-json-had-quietly-turned-two-grids-into-a-sentence) |
| **D141** | [The README described a game with no card art, and had no pictures of the one it had](#d141--the-readme-described-a-game-with-no-card-art-and-had-no-pictures-of-the-one-it-had) |
| **D142** | [One Ubuntu runner builds all three desktop platforms, and the download link is only stable because the tag never moves](#d142--one-ubuntu-runner-builds-all-three-desktop-platforms-and-the-download-link-is-only-stable-because-the-tag-never-moves) |
| **D143** | [The lead image was a nice picture of the layout and a poor picture of the game](#d143--the-lead-image-was-a-nice-picture-of-the-layout-and-a-poor-picture-of-the-game) |
| **D144** | [Five platforms out of three runners, and the one that is allowed to fail](#d144--five-platforms-out-of-three-runners-and-the-one-that-is-allowed-to-fail) |
| **D145** | [The repository was still called deckcrawl, and one badge was a number somebody typed](#d145--the-repository-was-still-called-deckcrawl-and-one-badge-was-a-number-somebody-typed) |
| **D146** | [Android worked first try, iOS did not, and the release job had no repository](#d146--android-worked-first-try-ios-did-not-and-the-release-job-had-no-repository) |
| **D147** | [A red job nobody can debug is worse than a job that is switched off](#d147--a-red-job-nobody-can-debug-is-worse-than-a-job-that-is-switched-off) |
| **D148** | [A badge went red for one minute and stayed red, because GitHub caches the picture](#d148--a-badge-went-red-for-one-minute-and-stayed-red-because-github-caches-the-picture) |
| **D149** | [Two of the hero's four facings stood beside their own tile, because a painting's bounding box is not its feet](#d149--two-of-the-heros-four-facings-stood-beside-their-own-tile-because-a-paintings-bounding-box-is-not-its-feet) |
| **D150** | [Three sound packs at three sample rates is three games, and the file headers said so](#d150--three-sound-packs-at-three-sample-rates-is-three-games-and-the-file-headers-said-so) |
| **D151** | [The one name that cannot be renamed, and the four that could](#d151--the-one-name-that-cannot-be-renamed-and-the-four-that-could) |
| **D152** | [Five iso figures had been shredded by their own matte, and the paint was still in the files](#d152--five-iso-figures-had-been-shredded-by-their-own-matte-and-the-paint-was-still-in-the-files) |
| **D153** | [The matte's real discriminator is not colour and not an edge: a field has nothing in it](#d153--the-mattes-real-discriminator-is-not-colour-and-not-an-edge-a-field-has-nothing-in-it) |
| **D154** | [A negative width does not mean what the floor thought, and a front/back pair cannot share one mirror rule](#d154--a-negative-width-does-not-mean-what-the-floor-thought-and-a-frontback-pair-cannot-share-one-mirror-rule) |
| **D155** | [The fix was already in; the harness and my own metrics were the last thing lying](#d155--the-fix-was-already-in-the-harness-and-my-own-metrics-were-the-last-thing-lying) |
| **D156** | [Every published build has the same filename, so the build had to say its own name](#d156--every-published-build-has-the-same-filename-so-the-build-had-to-say-its-own-name) |
| **D157** | ["App not installed" is what Android says when the signature changed, and it says nothing else](#d157--app-not-installed-is-what-android-says-when-the-signature-changed-and-it-says-nothing-else) |
| **D158** | [The downloads badge was not broken, it was being reset several times a day](#d158--the-downloads-badge-was-not-broken-it-was-being-reset-several-times-a-day) |
| **D159** | [The signing-key script asked for a password twice and then admitted it had no JDK](#d159--the-signing-key-script-asked-for-a-password-twice-and-then-admitted-it-had-no-jdk) |
| **D160** | [The signing key is ignored by pattern, and a test makes sure the pattern covers what the script writes](#d160--the-signing-key-is-ignored-by-pattern-and-a-test-makes-sure-the-pattern-covers-what-the-script-writes) |
| **D161** | [Repository secrets: not variables, because they are plaintext, and not environment secrets, because this job has no environment](#d161--repository-secrets-not-variables-because-they-are-plaintext-and-not-environment-secrets-because-this-job-has-no-environment) |
| **D162** | [The diagnostic from D161 named the wrong cause, because the password had a default and keytool prints on stdout](#d162--the-diagnostic-from-d161-named-the-wrong-cause-because-the-password-had-a-default-and-keytool-prints-on-stdout) |
| **D163** | [The title screen kept the generator's sparkle, because one image cannot form an intersection](#d163--the-title-screen-kept-the-generators-sparkle-because-one-image-cannot-form-an-intersection) |
| **D164** | [One door to How This Works, and the hint that pointed at the other one](#d164--one-door-to-how-this-works-and-the-hint-that-pointed-at-the-other-one) |
| **D165** | [The one heading written as interface, and the row that was left holding a spacer](#d165--the-one-heading-written-as-interface-and-the-row-that-was-left-holding-a-spacer) |
| **D166** | [Rules on one screen, progress on the screens that own it](#d166--rules-on-one-screen-progress-on-the-screens-that-own-it) |
| **D167** | [A key is somewhere, not a chance](#d167--a-key-is-somewhere-not-a-chance) |
| **D168** | [Four directions that are always there, and a legend where the buttons were](#d168--four-directions-that-are-always-there-and-a-legend-where-the-buttons-were) |
| **D169** | [The reveal was the half that could not scroll](#d169--the-reveal-was-the-half-that-could-not-scroll) |
| **D170** | [The APK installed on half the phones it was offered to](#d170--the-apk-installed-on-half-the-phones-it-was-offered-to) |
| **D171** | [A new title painting, and the moon that the "nothing pure white" line caught](#d171--a-new-title-painting-and-the-moon-that-the-nothing-pure-white-line-caught) |
| **D172** | [A lock the player can see from the doorway, and a key count that stopped guessing](#d172--a-lock-the-player-can-see-from-the-doorway-and-a-key-count-that-stopped-guessing) |
| **D173** | [The sound was uniform, and it was a chiptune](#d173--the-sound-was-uniform-and-it-was-a-chiptune) |
| **D174** | [The reward asked the player to choose between three cards and told them nothing about any of them](#d174--the-reward-asked-the-player-to-choose-between-three-cards-and-told-them-nothing-about-any-of-them) |
| **D175** | [Difficulty the player chooses, and the flat multiplier that was built first and thrown away](#d175--difficulty-the-player-chooses-and-the-flat-multiplier-that-was-built-first-and-thrown-away) |
| **D176** | [The floor had two visual axes and none of them was inside a room](#d176--the-floor-had-two-visual-axes-and-none-of-them-was-inside-a-room) |
| **D177** | [A dungeon's floors were all the same place](#d177--a-dungeons-floors-were-all-the-same-place) |
| **D178** | [The world was a ladder, and it was not the gates that made it one](#d178--the-world-was-a-ladder-and-it-was-not-the-gates-that-made-it-one) |
| **D179** | [One walker was measuring one route and reporting it as the pace of the game](#d179--one-walker-was-measuring-one-route-and-reporting-it-as-the-pace-of-the-game) |
| **D180** | [The simulator priced every relic and delivered only some of them](#d180--the-simulator-priced-every-relic-and-delivered-only-some-of-them) |
| **D181** | [The game was wearing the engine's logo](#d181--the-game-was-wearing-the-engines-logo) |
| **D182** | [There was one thing to do in a dungeon, and a secret has to be a dead end to be safe](#d182--there-was-one-thing-to-do-in-a-dungeon-and-a-secret-has-to-be-a-dead-end-to-be-safe) |
| **D183** | [The guard, which is the only thing in the game that can make a run harder than its rating](#d183--the-guard-which-is-the-only-thing-in-the-game-that-can-make-a-run-harder-than-its-rating) |
| **D184** | [An errand has to ask for MORE, or it is a difficulty dial wearing a quest marker](#d184--an-errand-has-to-ask-for-more-or-it-is-a-difficulty-dial-wearing-a-quest-marker) |
| **D185** | [Two more ways to shut a pocket, and a thing standing in the open](#d185--two-more-ways-to-shut-a-pocket-and-a-thing-standing-in-the-open) |
| **D186** | [A riddle you can memorise is furniture, so the answer is the floor](#d186--a-riddle-you-can-memorise-is-furniture-so-the-answer-is-the-floor) |
| **D187** | [A place you have cleared should not be the same place](#d187--a-place-you-have-cleared-should-not-be-the-same-place) |
| **D188** | [A stone that takes something, built out of the aspects rather than beside them](#d188--a-stone-that-takes-something-built-out-of-the-aspects-rather-than-beside-them) |
| **D189** | [Barred doors were built, measured and deleted](#d189--barred-doors-were-built-measured-and-deleted) |
| **D190** | [The back door, which had to bring the budget with it](#d190--the-back-door-which-had-to-bring-the-budget-with-it) |
| **D191** | [Debts: pick what you owe](#d191--debts-pick-what-you-owe) |
| **D192** | [The brightest thing on the floor was being drawn under the player](#d192--the-brightest-thing-on-the-floor-was-being-drawn-under-the-player) |
| **D193** | [The settings screen was 972px tall in a 720px window](#d193--the-settings-screen-was-972px-tall-in-a-720px-window) |
...
| `scripts/collection.gd` | The one **Cards** screen: collection, fusion, and per-dungeon deck assembly. Three states derived from `GameState`, not flagged (D133). Still reached through `scenes/DeckBuilder.tscn`, which is why the capture is called `DeckBuilder`. |
...
### D103b — CORRECTION: its absolute table is superseded

*Numbered D103 when written, and so was the entry above it. Renumbered in D196; a
reference to plain "D103" means the re-tune, not this correction to it.*
...
### D109b — The monsters were not floating; they were standing on a gold lozenge

*Numbered D109 when written, and so was the level-curve entry above it. Renumbered in
D196; a reference to plain "D109" means the level curve, which is the one every pillar
cites.*
...
### D125b — Three shipped files were nine-tenths transparent and looked perfect in a file browser

*Numbered D125 when written, and so was the backdrop entry above it. Renumbered in D196.
This is the `lumakey` half — the cutout, the watermark and the art that was read by
nothing; plain "D125" is the half about quiet not being empty.*
...
### D138b — The level overlay does not always work, and the reason is saturation not visibility

*Numbered D138 when written, and so was the cursor entry above it. Renumbered in D196; a
reference to plain "D138" means the pointer the game had taken.*
...
### D196 — The documentation had drifted in the two ways it warns about, and one of them was in the file that does the warning

A read of all thirteen markdown files against the tree. No feature work; this is the
docs paying the debt the rest of the project keeps a log to avoid.

#### The structure was broken, and it was invisible in a diff

`DESIGN.md` had **131 `##` headings where there are 8 chapters.** From D115 onward,
subsections inside a `### D##` entry were written at `##` — a level *above* their own
parent — so in any outline, table of contents or folded view every entry appeared to end
where its first subsection began. Twenty-three `####` headings elsewhere in the file show
the right convention was used and then quietly dropped.

Two of those runs were not headings at all: a supersession note in D138b and another in
D152 had `## ` prefixed to **every line of a paragraph**, four and five lines of prose
rendering as four and five headings. Both are blockquotes now.

**This is why it survived.** A wrong heading level renders as text of the wrong size, and
prose that reads correctly in a plain-text diff is prose nobody re-reads. The defect had
been accumulating for seventy-seven decisions.

#### Four decision numbers named two decisions each

D103, D109, D125 and D138 were each used twice. D112 records two of them being left alone
on purpose — a concurrent session held the entries and renumbering another session's
in-flight work is how you get three of them — which was right at the time and then nobody
came back. The second of each pair takes a letter now, following the `D83b` convention
already in the file:

| was | is | which one plain `D###` still means |
|---|---|---|
| D103 (correction) | **D103b** | the fourteen constants |
| D109 (gold lozenge) | **D109b** | the level curve — the one every pillar cites |
| D125 (`lumakey`) | **D125b** | quiet is not empty |
| D138 (level overlay) | **D138b** | the pointer |

Suffixing rather than renumbering was deliberate: about a hundred references across the
tree say plain `D125`, and a suffix leaves every one of them resolving to the first entry
instead of breaking all of them. The seven references that provably meant the second half
were retargeted; each renamed entry carries a line saying what happened.

D48, D93, D100 and D110 are cited and have **no entry at all**. Not invented here — the
index prints them, because a reference to a decision nobody wrote up is worth seeing.

#### The index, and why it is generated

REVIEW.md's P2 #16 asked to "split DESIGN.md by system, or give it an index" and had been
open since 2026-08-01. An index, because a split moves every `D##` cross-reference in the
other twelve documents. It is `tools/design_index.sh`, generated for the reason D34, D111
and D128 all record — a hand-kept list of what a file contains goes stale on the next
decision.

**It carries no line numbers**, and the first version did. The index sits at the top of
the file it indexes, so writing line numbers makes the block move the numbers it just
wrote: `--check` failed against its own output. Anchors are the durable handle. *A
generated document that includes its own position in what it measures cannot converge.*

#### The generated art documents disagreed, because only one was ever regenerated

`ART_PROMPTS.md` was asking for **sixty card illustrations and a gear symbol that were all
on disk.** `ART_ASSETS.md`, off the same tool and the same catalogues, correctly said
310/310/0. D101 already wrote this rule — *"Regenerate the generated docs in the commit
that changes what they describe"* — and it was followed for one of the pair.

`ART_ASSETS.md` also shipped with **Godot's version banner as line 1**, above its own
"GENERATED — do not edit by hand" comment, because `> ART_ASSETS.md` captures the engine's
startup print. The command was quoted in six documents and the strip in none of them.

Both are fixed by `tools/art_docs.sh`: writes both, strips the banner, `--check` fails if
either drifted. The generator now prints that command in its own header, so the next
person copies the working one.

#### What was restated and wrong

Every one of these is the failure D34 names — a document restating a number something else
owns:

| claim | said | actual |
|---|---|---|
| capture count | 16 (ART.md), 19 (ART.md ×2), 25 (README) | **32**, in `SHOTS` |
| decision range | "D1 through D140" (README) | past D190 |
| ART.md tier table | per-tier file counts, two tiers marked done | all tiers done |
| `scripts/deck_builder.gd` | listed in DESIGN.md §3 | merged into `collection.gd` in D133 |
| `main_menu.jpg` "RE-ROLL, off-style" | `assets/art/README.md` | it is `main_menu.png`, re-rolled in D126 and D134 |
| ART.md Tier 1 VFX | six sprite sheets to draw | drawn at runtime by `scripts/fx.gd` (D129) |
| `assets/art/bg_chest.png` | REVIEW.md defect 8 | never existed; the file is `bg_treasure.png` |

None was replaced with a corrected number. Each was replaced with a pointer to the thing
that owns it, which is the only version of the fix that stays fixed.

#### REVIEW.md was listing eight finished jobs as open

Its own header promises the P-lists "stay usable as a work queue", and the queue had not
been reconciled in a long time. Still-open when checked: the crawl header (fixed D114), the
card illustrations (D131/D136), vitals and intent art, relic and power icons, combat FX
(D129), the empty states, the simulator profile (D99, 1142s → 420s), and its own request for
an index.

**Four items are genuinely open** and are now the only four: the collection as a grid of
card faces rather than rows, the isometric floor filling the screen, the eighteen numeric
relics, and keyboard/gamepad input. The last has not moved at all — `project.godot` still
has no `[input]` section and there is still no `grab_focus` anywhere in `scripts/`.

Checked, not assumed: each claim was tested against the tree rather than read off another
document. That is how the eight were found, and it is what "the docs are current" has to
mean.

#### What was NOT consolidated, and why

Three apparent duplications are not duplications, and merging them would have lost
something:

- **The directory tree appears in three files at three granularities** — README's short
  orientation, AGENTS.md's per-directory layout with the tool annotations, DESIGN.md §3's
  per-file responsibility table. Different questions, different answers.
- **AGENTS.md's engineering lessons restate DESIGN.md entries.** That restatement is the
  point: the log is chronological and unreadable in bulk, and the lessons are the
  distillation. The failure mode to watch is the lesson outliving the entry, not the
  overlap.
- **The four `assets/art/*/README.md` files** sit beside the assets they describe and are
  read by whoever opens that directory. Folding them into ART.md would move them away from
  their subject.

The generalisation: **a document that repeats another at a different altitude is doing a
job; a document that repeats another at the same altitude is a second place to go stale.**
Only the second kind was collapsed.

#### The rule this leaves behind

The project already knows that a hand-kept list of *content* goes stale, and generates
those. It did not apply the same standard to prose about itself. Both new generators take
`--check`, so the question "has this drifted" is answerable without reading anything:

    tools/design_index.sh --check
    tools/art_docs.sh --check

Neither is wired into `tests/run.sh`, deliberately — the suite count is asserted by
`test_content.gd` and pinned to the README badge, so adding a suite here would fail the
build for a documentation change. Wiring them in means correcting the badge in the same
commit.
...
### D194 — The rat was fighting alongside somebody else's legs

> "I am battling rats in the Warren and their sprite is just wrong, there seems to be
> parts of another enemy in it."

There was. `enemies/rat_swarm.png` held two subjects: a rat across the bottom third, and
above it, with 55px of clear air between them, the lower half of a robed figure — hem,
sleeves and two hands. The rat was the smaller of the two by mass. It arrived in the batch
that painted the last eleven plates and survived four days and 42 passing tests.

#### Why nothing caught it

`install_cutouts` runs `matte → despeckle → trim → scale → anchor`, and the pass that
exists to remove things that are not the subject is `despeckle`. It asks exactly one
question — *is this island smaller than 8% of the largest one* — and answers it well. It
was built against the generator's watermark, which is a speck in a corner.

**A second monster is not a speck.** It was 151% the size of the rat, so it sailed through
the only filter in the pipeline that could have looked at it, and then did the damage
`despeckle`'s own comment predicts for a surviving watermark: the trim box stretched around
both bodies, and the rat installed at a third of the canvas it should have filled. In the
game that is an enemy rendered at 113px where the plague rat beside it gets 273 — small,
detached, with a stranger's legs standing over it.

The install log said `256x256` and nothing else. Anchoring was correct, coverage was inside
its bounds, the filename matched an archetype, and the file was not corrupt. Every existing
check passed because every existing check was asking about one subject.

#### The rule: big, and with air under it

Stated as "more than one component" it fails immediately — a moth's wing scales are fifteen
components, a hexer's sleeves are two, and `false_step` is a stair tread resting on a maw.
So the question is asked with two thresholds, and they were picked by measuring all 310
installed cutouts rather than by eye:

| file | second component | vertical gap |
|---|---|---|
| `rat_swarm` | 66% of the largest | **55px** |
| `powers/expose` | 94% | overlaps fully |
| `powers/blight` | 66% | overlaps fully |
| `relics/merchants_seal` | 49% | overlaps |
| `enemies/false_step` | 36% | 4px |
| `relics/coin_purse` | 13% | 3px |

Size alone separates nothing — `expose` is two arcs of one ring at 94%. **The gap is the
whole signal.** Every legitimate multi-part cutout in the project either overlaps its own
other half or sits directly on it; the one broken file has a 55px hole. `STOWAWAY_MIN`
0.20 and `STOWAWAY_GAP` 5% of the frame land in the space between 4 and 55.

The check runs only on the **bottom-anchored** families, and that is the premise it rests
on rather than a scoping convenience: an enemy plate is one figure standing on
`PixelArt.STAND_LINE`, so the pipeline knows which body is the subject — the one reaching
lowest — and can call the other one an intruder. A relic is a composition and may
legitimately be two pieces with air between them. (In the rat's case the intruder was the
*bigger* of the two, so "keep the largest" would have installed the robe and deleted the
rat.)

#### It refuses; it does not clean up

Default behaviour is to fail the install with the measurement in the message. The honest
fix for a frame with two monsters in it is another painting, and a tool that quietly
...
what the drawing is, and it will be right whenever the plate is repainted.

#### The measure stays after the defect goes

`test_art.gd` asks the same question of every installed plate, through
`PixelArt.enemy_art()` — the imported texture `combat.gd` actually draws, not the loose PNG
— and calls into `cutout_lib` for the thresholds rather than restating them, which is the
D34 habit that has already cost this project four bugs. Reverting the file to the broken
version fails it with the same sentence the installer would have printed:

    FAIL enemies/rat_swarm.png: a second subject in the frame — 173x115 at (24,5),
         151% the size of the subject.

42 passed, 0 failed.

### D195 — The Brood-Mother's abdomen was cut out of her and called background

> "The image of the Boss in the Warren the brood mother is wrong. Parts of the image
> were removed considering it the background."

`enemies/brood_mother.png` had a 4009px hole through the middle of it — the whole egg-sac,
a sixth of the frame, gone from between her own legs, with a few dark markings left
floating in the gap. She is a boss, so she is drawn at 1.34x and the hole is the largest
thing on the screen.

#### What did it

`fill_trapped` (D92). The pass exists because the matte floods in from the frame edge and
stays connected, so field the silhouette SEALS OFF is unreachable and ships as a slab —
the triangle between two legs, the eye of a hook. It recognises a pocket by three things:
enclosed, over `HOLE_MIN` of the frame, and featureless, where featureless means
`POCKET_STD`: the **mean of the local 5x5 deviation**.

That statistic cannot see a gradient. A smooth airbrushed sac is flat at every individual
pixel and nothing like one colour overall, so it measured as field. Its base tone also sits
within `HOLE_TOL` of the slate she was painted on, which is what made it a seed — and once
a seed is accepted, D92's own rule is that it has earned the ordinary `TOL` to grow at.
It grew across the entire abdomen.

Nothing said a word. Coverage stayed inside `MIN_COVER`/`MAX_COVER`, the border was flat,
the filename matched, `despeckle` had nothing to drop — a trapped pocket touches the
subject, so it is part of the subject's own component — and the install log printed
`512x512  (filled N trapped background pocket(s))`, which is what a correct run prints too.

#### The repair is exact, because the paint never left

The pipeline only ever writes the ALPHA channel. `matte`, `fill_trapped` and `clear_bloom`
all zero `a[]` and leave the colour alone, and `place` resizes RGBA without premultiplying.
So the abdomen was never lost — it was sitting in the file at full colour with its alpha set
to zero, and restoring it is a restore rather than an inpaint. `tools/refill_pockets.gd`
puts the alpha back over an enclosed pocket and walks up to `RIM_R` out through the
partially-transparent band `feather_edge` graded around the false hole, which is otherwise
left behind as a bright outline drawn around the repair.

That the sources are gone is why this is a tool and not a re-cut. It is the same situation
D194's rat was in, and the same answer: salvage the installed file.

#### Eight candidates, one defect — and no measure that separated them

The obvious next move was to find the others. Over the 18 enclosed pockets in the installed
enemy, relic and power sets, luma spread looked decisive:

    field, apparently   leather_wrap 0.25 · bramble 0.69 · bone_picker 1.09 · blight 1.19
                        crown_of_thorns 1.25 · cinder_knight 1.45, 1.47 · foresight 1.66
                        siphon 1.72, 1.85
    paint, apparently   the_gardener 3.08 · grave_sexton 3.77 · bone_picker 5.51
                        crypt_hound 5.73 · rot_priest 13.37 · ember_hound 14.82
                        brood_mother 16.06 · ancient_battery 24.03

**Then the eight were painted red and looked at, and seven of them were correct
background.** The gap between a crypt-hound's legs. The space under the Gardener's robe.
The slot between the ancient battery's pillars. They score high because the field BEHIND
the subject is shadowed or lit — a burning hound lights the floor it stands on — so the
untouched field genuinely carries a gradient, and the one real defect (16.06) sits between
two false ones (14.82 and 24.03).

Fitting a plane to each pocket and measuring the residual was tried next, on the theory
that a shadow ramp fits and painted structure does not. The residual tracks the spread at
0.76-1.00 across all eighteen. It separates nothing.

So there is no statistic here, and the honest conclusion is that a finished cutout does not
carry the evidence: with the source and the sampled field colour both gone, "flat grey
sealed inside a silhouette" describes the defect and the feature equally well.
`find_gouges` therefore returns a **shortlist to look at**, `refill_pockets` has no
`--all`, and none of it is wired into `test_art.gd` — an assertion with seven false
positives out of eight is not a measure, it is noise that teaches the suite to be ignored.
D194 could add its check because the rat's 55px of air was the only one in 310 files. This
is the case where that does not happen, and pretending otherwise would have shipped a
failing suite and six re-gouged cutouts.

#### The pipeline can still ask, because upstream the evidence still exists

`fill_trapped` has what the finished file does not: the source, and the field colour the
border fill actually sampled. So the fix goes there, as a third question asked after the
growth rather than of the seed — **testing the seed catches nothing**, since a seed is by
construction the pixels within `HOLE_TOL` of the field and its spread is near zero whatever
it sits on. What has to be measured is what the growth TOOK.

Three things make it safe enough to ship:

- **Measured on the region's interior**, two pixels clear of its boundary. The boundary is
  the ramp where field meets the subject's outline, and a ramp from field to ink is 40
  levels wide whatever it encloses. Measured whole, `leather_wrap`'s 0.25 pocket reads like
  the Brood-Mother's abdomen and the question answers itself wrong every time.
- **It only ever refuses a region over 1% of the frame** (`POCKET_GUARD_MIN`). The two
  mistakes are not the same size: filling a 300px pocket that was really paint is a
  blemish, filling a 60,000px one is a hole through a boss. The abdomen was 6.1%. Below 1%
  the pass behaves exactly as it did.
- **Its failure mode is loud.** A refusal prints `(kept N enclosed area(s) — they carry
  paint, not field)` per file, so a slab of field left inside a subject is a line in the
  install log. The defect it replaces printed nothing at all. That trade — a silent
  destruction for a reported blemish — is the whole justification, and it is the same one
  `despeckle` and `_stowaways` already make.

#### What is not yet known

The threshold is 2.5, from the gap between 1.85 and 3.08 in the table above — measured on
256px OUTPUTS, because the 1024px sources for the installed set no longer exist. Two checks
stand behind it and neither is the real thing:

- A synthetic 1024px subject with a smooth gradient sealed inside it is refused, and the
  same subject with genuine flat field in the same hole is still cleared.
- Rebuilding a source-like painting from the repaired file — subject over flat field at
  1024 — reproduces the gouge with the guard off (abdomen 4875/10000 px opaque) and does
  not with it on (9694/10000).

Reconstructions upsample 4x, which rings every edge and inflates the interior measurement,
