...
breaking it. The *what* — file-by-file detail and the full decision log D1–D74 — is
...
3. **Run** — traverse the dungeon (a node graph, a card draw, a dice board, or an
   isometric floor crawled by torchlight, depending on the dungeon), fighting,
   shopping, resting, and hitting events, up to a named boss.
...
10 powers · 20 events · 12 dungeons across 5 zones · 4 traversal models · 34 test
...
tools/       diagnostics, not shipped: sim_balance.gd, playthrough.gd, debug_map.gd,
             ...
             install_backdrops.gd
DESIGN.md    the full reasoning, decision by decision (D1–D74)
