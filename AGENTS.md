...
breaking it. The *what* — file-by-file detail and the full decision log D1–D133 — is
...
- **A silent partial success is worse than a failure, and the installers can produce one.**
  ...
  (D125). **Both look perfect in an image viewer**, because the matte destroys alpha and
...
DESIGN.md    the full reasoning, decision by decision (D1–D133)
